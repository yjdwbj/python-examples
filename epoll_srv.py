...
class MPConsumer(multiprocessing.Process):
    ...
    def notify_uuid_app_logout(self,fileno):
        ...
        if self.appbinds.has_key(fileno):
            ...
            #[notify_peer_is_logout(n,fileno) for n in binds if self.devsock.has_key(n)]
            nl = [(n,fileno) for n in binds if self.devsock.has_key(n)]
    ...
    def notify_app_uuid_logout(self,fileno):
        ...
        #[notify_peer_is_logout(n,fileno) for n in binds if self.appsock.has_key(n)]
